/* src/config/aiccoin-config.h.  Generated from aiccoin-config.h.in by configure.  */
/* src/config/aiccoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Aiccoin Core"
...
/* Name of package */
#define PACKAGE "aiccoin_clilib"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "BUG-REPORT-ADDRESS"

/* Define to the full name of this package. */
#define PACKAGE_NAME "aiccoin_clilib"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "aiccoin_clilib 1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aiccoin_clilib"
